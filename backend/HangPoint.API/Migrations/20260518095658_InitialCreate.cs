        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasSharedLocation = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HangoutDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    MeetingPoint = table.Column<string>(type: "text", nullable: false),
                    MeetingLat = table.Column<double>(type: "double precision", nullable: false),
                    MeetingLng = table.Column<double>(type: "double precision", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Itineraries_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    City = table.Column<string>(type: "text", nullable: false),
                    MidpointLat = table.Column<double>(type: "double precision", nullable: true),
                    MidpointLng = table.Column<double>(type: "double precision", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedCostPerPerson = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Votes_Itineraries_ItineraryId",
                        column: x => x.ItineraryId,
                        principalTable: "Itineraries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Votes_ItineraryId",
                table: "Votes",
                column: "ItineraryId");

            migrationBuilder.CreateIndex(
                name: "IX_Votes_UserId_ItineraryId",
                table: "Votes",
                columns: new[] { "UserId", "ItineraryId" },
                unique: true);
        }
